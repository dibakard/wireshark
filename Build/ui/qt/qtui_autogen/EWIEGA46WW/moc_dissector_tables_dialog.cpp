...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_DissectorTablesDialog_t, stringdata0) + ofs), len 
static const qt_meta_stringdata_DissectorTablesDialog_t qt_meta_stringdata_DissectorTablesDialog = {
    {
QT_MOC_LITERAL(0, 21), // "DissectorTablesDialog"
QT_MOC_LITERAL(22, 28), // "on_txtSearchLine_textChanged"
QT_MOC_LITERAL(51, 0), // ""
QT_MOC_LITERAL(52, 9) // "search_re"
...
void DissectorTablesDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<DissectorTablesDialog *>(_o);
        (void)_t;
        switch (_id) {
        case 0: _t->on_txtSearchLine_textChanged((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1]))); break;
        default: ;
        }
    }
}
...
const QMetaObject DissectorTablesDialog::staticMetaObject = { {
    ...
    qt_meta_stringdata_DissectorTablesDialog.offsetsAndSize,
    qt_meta_data_DissectorTablesDialog,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_DissectorTablesDialog_t
, QtPrivate::TypeAndForceComplete<DissectorTablesDialog, std::true_type>
