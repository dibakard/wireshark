...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_StatsTreeDialog_t, stringdata0) + ofs), len 
static const qt_meta_stringdata_StatsTreeDialog_t qt_meta_stringdata_StatsTreeDialog = {
    {
QT_MOC_LITERAL(0, 15), // "StatsTreeDialog"
QT_MOC_LITERAL(16, 8), // "fillTree"
QT_MOC_LITERAL(25, 0) // ""
...
void StatsTreeDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<StatsTreeDialog *>(_o);
        (void)_t;
        switch (_id) {
...
const QMetaObject StatsTreeDialog::staticMetaObject = { {
    ...
    qt_meta_stringdata_StatsTreeDialog.offsetsAndSize,
    qt_meta_data_StatsTreeDialog,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_StatsTreeDialog_t
, QtPrivate::TypeAndForceComplete<StatsTreeDialog, std::true_type>
