...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_PacketCommentDialog_t, stringdata0) + ofs), len 
static const qt_meta_stringdata_PacketCommentDialog_t qt_meta_stringdata_PacketCommentDialog = {
    {
QT_MOC_LITERAL(0, 19), // "PacketCommentDialog"
QT_MOC_LITERAL(20, 26), // "on_buttonBox_helpRequested"
QT_MOC_LITERAL(47, 0) // ""
...
void PacketCommentDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<PacketCommentDialog *>(_o);
        (void)_t;
        switch (_id) {
...
const QMetaObject PacketCommentDialog::staticMetaObject = { {
    ...
    qt_meta_stringdata_PacketCommentDialog.offsetsAndSize,
    qt_meta_data_PacketCommentDialog,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_PacketCommentDialog_t
, QtPrivate::TypeAndForceComplete<PacketCommentDialog, std::true_type>
