...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_SimpleStatisticsDialog_t, stringdata0) + ofs), len 
static const qt_meta_stringdata_SimpleStatisticsDialog_t qt_meta_stringdata_SimpleStatisticsDialog = {
    {
QT_MOC_LITERAL(0, 22), // "SimpleStatisticsDialog"
...
void SimpleStatisticsDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<SimpleStatisticsDialog *>(_o);
        (void)_t;
        switch (_id) {
...
const QMetaObject SimpleStatisticsDialog::staticMetaObject = { {
    ...
    qt_meta_stringdata_SimpleStatisticsDialog.offsetsAndSize,
    qt_meta_data_SimpleStatisticsDialog,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_SimpleStatisticsDialog_t
, QtPrivate::TypeAndForceComplete<SimpleStatisticsDialog, std::true_type>
