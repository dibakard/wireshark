...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_ResponseTimeDelayDialog_t, stringdata0) + ofs), len 
static const qt_meta_stringdata_ResponseTimeDelayDialog_t qt_meta_stringdata_ResponseTimeDelayDialog = {
    {
QT_MOC_LITERAL(0, 23), // "ResponseTimeDelayDialog"
QT_MOC_LITERAL(24, 8), // "fillTree"
QT_MOC_LITERAL(33, 0) // ""
...
void ResponseTimeDelayDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<ResponseTimeDelayDialog *>(_o);
        (void)_t;
        switch (_id) {
...
const QMetaObject ResponseTimeDelayDialog::staticMetaObject = { {
    ...
    qt_meta_stringdata_ResponseTimeDelayDialog.offsetsAndSize,
    qt_meta_data_ResponseTimeDelayDialog,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_ResponseTimeDelayDialog_t
, QtPrivate::TypeAndForceComplete<ResponseTimeDelayDialog, std::true_type>
