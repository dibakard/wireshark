...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_UatModel_t, stringdata0) + ofs), len 
static const qt_meta_stringdata_UatModel_t qt_meta_stringdata_UatModel = {
    {
QT_MOC_LITERAL(0, 8) // "UatModel"
...
const QMetaObject UatModel::staticMetaObject = { {
    ...
    qt_meta_stringdata_UatModel.offsetsAndSize,
    qt_meta_data_UatModel,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_UatModel_t
, QtPrivate::TypeAndForceComplete<UatModel, std::true_type>
