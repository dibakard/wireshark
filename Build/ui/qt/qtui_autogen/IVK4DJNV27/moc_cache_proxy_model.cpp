...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_CacheProxyModel_t, stringdata0) + ofs), len 
static const qt_meta_stringdata_CacheProxyModel_t qt_meta_stringdata_CacheProxyModel = {
    {
QT_MOC_LITERAL(0, 15), // "CacheProxyModel"
QT_MOC_LITERAL(16, 15), // "resetCacheModel"
QT_MOC_LITERAL(32, 0) // ""
...
void CacheProxyModel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<CacheProxyModel *>(_o);
        (void)_t;
        switch (_id) {
...
const QMetaObject CacheProxyModel::staticMetaObject = { {
    QMetaObject::SuperData::link<QIdentityProxyModel::staticMetaObject>(),
    qt_meta_stringdata_CacheProxyModel.offsetsAndSize,
    qt_meta_data_CacheProxyModel,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_CacheProxyModel_t
, QtPrivate::TypeAndForceComplete<CacheProxyModel, std::true_type>
