...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_ColumnListModel_t, stringdata0) + ofs), len 
static const qt_meta_stringdata_ColumnListModel_t qt_meta_stringdata_ColumnListModel = {
    {
QT_MOC_LITERAL(0, 15) // "ColumnListModel"
...
const QMetaObject ColumnListModel::staticMetaObject = { {
    ...
    qt_meta_stringdata_ColumnListModel.offsetsAndSize,
    qt_meta_data_ColumnListModel,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_ColumnListModel_t
, QtPrivate::TypeAndForceComplete<ColumnListModel, std::true_type>
