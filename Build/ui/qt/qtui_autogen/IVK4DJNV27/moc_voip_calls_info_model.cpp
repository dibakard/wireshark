...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_VoipCallsInfoModel_t, stringdata0) + ofs), len 
static const qt_meta_stringdata_VoipCallsInfoModel_t qt_meta_stringdata_VoipCallsInfoModel = {
    {
QT_MOC_LITERAL(0, 18) // "VoipCallsInfoModel"
...
const QMetaObject VoipCallsInfoModel::staticMetaObject = { {
    QMetaObject::SuperData::link<QAbstractTableModel::staticMetaObject>(),
    qt_meta_stringdata_VoipCallsInfoModel.offsetsAndSize,
    qt_meta_data_VoipCallsInfoModel,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_VoipCallsInfoModel_t
, QtPrivate::TypeAndForceComplete<VoipCallsInfoModel, std::true_type>
