...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_ExpertInfoProxyModel_t, stringdata0) + ofs), len 
static const qt_meta_stringdata_ExpertInfoProxyModel_t qt_meta_stringdata_ExpertInfoProxyModel = {
    {
QT_MOC_LITERAL(0, 20) // "ExpertInfoProxyModel"
...
const QMetaObject ExpertInfoProxyModel::staticMetaObject = { {
    ...
    qt_meta_stringdata_ExpertInfoProxyModel.offsetsAndSize,
    qt_meta_data_ExpertInfoProxyModel,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_ExpertInfoProxyModel_t
, QtPrivate::TypeAndForceComplete<ExpertInfoProxyModel, std::true_type>
