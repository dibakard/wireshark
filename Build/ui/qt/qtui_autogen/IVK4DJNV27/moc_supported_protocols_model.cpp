...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_SupportedProtocolsModel_t, stringdata0) + ofs), len 
static const qt_meta_stringdata_SupportedProtocolsModel_t qt_meta_stringdata_SupportedProtocolsModel = {
    {
QT_MOC_LITERAL(0, 23) // "SupportedProtocolsModel"
...
const QMetaObject SupportedProtocolsModel::staticMetaObject = { {
    ...
    qt_meta_stringdata_SupportedProtocolsModel.offsetsAndSize,
    qt_meta_data_SupportedProtocolsModel,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_SupportedProtocolsModel_t
, QtPrivate::TypeAndForceComplete<SupportedProtocolsModel, std::true_type>
