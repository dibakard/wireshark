...
public:
    ...
    void setupUi(QFrame *LayoutPreferencesFrame)
    {
        ...
        pane1PacketDiagramRadioButton->setObjectName(QString::fromUtf8("pane1PacketDiagramRadioButton"));
        ...
        pane2PacketDiagramRadioButton->setObjectName(QString::fromUtf8("pane2PacketDiagramRadioButton"));
        ...
        pane3PacketDiagramRadioButton->setObjectName(QString::fromUtf8("pane3PacketDiagramRadioButton"));
        ...
        packetListHeaderShowColumnDefinition->setObjectName(QString::fromUtf8("packetListHeaderShowColumnDefinition"));
        ...
        packetListAllowSorting->setObjectName(QString::fromUtf8("packetListAllowSorting"));

        verticalLayout_4->addWidget(packetListAllowSorting);

        packetListCachedRows = new QHBoxLayout();
        packetListCachedRows->setObjectName(QString::fromUtf8("packetListCachedRows"));
        packetListCachedRowsLabel = new QLabel(LayoutPreferencesFrame);
        packetListCachedRowsLabel->setObjectName(QString::fromUtf8("packetListCachedRowsLabel"));
        ...
        packetListCachedRowsLineEdit->setObjectName(QString::fromUtf8("packetListCachedRowsLineEdit"));

        packetListCachedRows->addWidget(packetListCachedRowsLineEdit);

        packetListCachedRowsHorizontalSpacer = new QSpacerItem(0, 0, QSizePolicy::Expanding, QSizePolicy::Minimum);
        ...
        packetListHoverStyleCheckbox->setObjectName(QString::fromUtf8("packetListHoverStyleCheckbox"));
