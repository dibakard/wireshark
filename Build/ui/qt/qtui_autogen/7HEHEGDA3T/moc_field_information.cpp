...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_FieldInformation_t, stringdata0) + ofs), len 
static const qt_meta_stringdata_FieldInformation_t qt_meta_stringdata_FieldInformation = {
    {
QT_MOC_LITERAL(0, 16) // "FieldInformation"
...
const QMetaObject FieldInformation::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_meta_stringdata_FieldInformation.offsetsAndSize,
    qt_meta_data_FieldInformation,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_FieldInformation_t
, QtPrivate::TypeAndForceComplete<FieldInformation, std::true_type>
