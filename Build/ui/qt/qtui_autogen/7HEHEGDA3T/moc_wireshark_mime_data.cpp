...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_ToolbarEntryMimeData_t, stringdata0) + ofs), len 
static const qt_meta_stringdata_ToolbarEntryMimeData_t qt_meta_stringdata_ToolbarEntryMimeData = {
    {
QT_MOC_LITERAL(0, 20) // "ToolbarEntryMimeData"
...
const QMetaObject ToolbarEntryMimeData::staticMetaObject = { {
    QMetaObject::SuperData::link<WiresharkMimeData::staticMetaObject>(),
    qt_meta_stringdata_ToolbarEntryMimeData.offsetsAndSize,
    qt_meta_data_ToolbarEntryMimeData,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_ToolbarEntryMimeData_t
, QtPrivate::TypeAndForceComplete<ToolbarEntryMimeData, std::true_type>
...
void *ToolbarEntryMimeData::qt_metacast(const char *_clname)
{
    ...
    return WiresharkMimeData::qt_metacast(_clname);
}

int ToolbarEntryMimeData::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    _id = WiresharkMimeData::qt_metacall(_c, _id, _a);
    return _id;
}
QT_WARNING_POP
