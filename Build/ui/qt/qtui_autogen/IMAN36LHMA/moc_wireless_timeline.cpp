...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_WirelessTimeline_t, stringdata0) + ofs), len 
static const qt_meta_stringdata_WirelessTimeline_t qt_meta_stringdata_WirelessTimeline = {
    {
QT_MOC_LITERAL(0, 16), // "WirelessTimeline"
QT_MOC_LITERAL(17, 22), // "bgColorizationProgress"
QT_MOC_LITERAL(40, 0), // ""
QT_MOC_LITERAL(41, 5), // "first"
QT_MOC_LITERAL(47, 4), // "last"
QT_MOC_LITERAL(52, 14), // "appInitialized"
QT_MOC_LITERAL(67, 20), // "selectedFrameChanged"
...
void WirelessTimeline::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<WirelessTimeline *>(_o);
        (void)_t;
        switch (_id) {
        case 0: _t->bgColorizationProgress((*reinterpret_cast< std::add_pointer_t<int>>(_a[1])),(*reinterpret_cast< std::add_pointer_t<int>>(_a[2]))); break;
        case 1: _t->appInitialized(); break;
        case 2: _t->selectedFrameChanged((*reinterpret_cast< std::add_pointer_t<QList<int>>>(_a[1]))); break;
        default: ;
        }
...
const QMetaObject WirelessTimeline::staticMetaObject = { {
    ...
    qt_meta_stringdata_WirelessTimeline.offsetsAndSize,
    qt_meta_data_WirelessTimeline,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_WirelessTimeline_t
, QtPrivate::TypeAndForceComplete<WirelessTimeline, std::true_type>
