/****************************************************************************
** Meta object code from reading C++ file 'drag_label.h'
**
...
#error "The header file 'drag_label.h' doesn't include <QObject>."
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_DragLabel_t, stringdata0) + ofs), len 
static const qt_meta_stringdata_DragLabel_t qt_meta_stringdata_DragLabel = {
    {
QT_MOC_LITERAL(0, 9) // "DragLabel"
...
const QMetaObject DragLabel::staticMetaObject = { {
    ...
    qt_meta_stringdata_DragLabel.offsetsAndSize,
    qt_meta_data_DragLabel,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_DragLabel_t
, QtPrivate::TypeAndForceComplete<DragLabel, std::true_type>
