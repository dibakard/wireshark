...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_OverlayScrollBar_t, stringdata0) + ofs), len 
static const qt_meta_stringdata_OverlayScrollBar_t qt_meta_stringdata_OverlayScrollBar = {
    {
QT_MOC_LITERAL(0, 16), // "OverlayScrollBar"
QT_MOC_LITERAL(17, 13), // "setChildRange"
QT_MOC_LITERAL(31, 0), // ""
...
void OverlayScrollBar::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<OverlayScrollBar *>(_o);
        (void)_t;
        switch (_id) {
        case 0: _t->setChildRange((*reinterpret_cast< std::add_pointer_t<int>>(_a[1])),(*reinterpret_cast< std::add_pointer_t<int>>(_a[2]))); break;
        default: ;
        }
    }
}
...
const QMetaObject OverlayScrollBar::staticMetaObject = { {
    ...
    qt_meta_stringdata_OverlayScrollBar.offsetsAndSize,
    qt_meta_data_OverlayScrollBar,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_OverlayScrollBar_t
, QtPrivate::TypeAndForceComplete<OverlayScrollBar, std::true_type>
