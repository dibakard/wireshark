...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_RangeSyntaxLineEdit_t, stringdata0) + ofs), len 
static const qt_meta_stringdata_RangeSyntaxLineEdit_t qt_meta_stringdata_RangeSyntaxLineEdit = {
    {
QT_MOC_LITERAL(0, 19), // "RangeSyntaxLineEdit"
QT_MOC_LITERAL(20, 10), // "checkRange"
QT_MOC_LITERAL(31, 0), // ""
QT_MOC_LITERAL(32, 5) // "range"
...
void RangeSyntaxLineEdit::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<RangeSyntaxLineEdit *>(_o);
        (void)_t;
        switch (_id) {
        case 0: _t->checkRange((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1]))); break;
        default: ;
        }
    }
}

const QMetaObject RangeSyntaxLineEdit::staticMetaObject = { {
    QMetaObject::SuperData::link<SyntaxLineEdit::staticMetaObject>(),
    qt_meta_stringdata_RangeSyntaxLineEdit.offsetsAndSize,
    qt_meta_data_RangeSyntaxLineEdit,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_RangeSyntaxLineEdit_t
, QtPrivate::TypeAndForceComplete<RangeSyntaxLineEdit, std::true_type>
