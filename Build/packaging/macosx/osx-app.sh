...
qt_frameworks_dir=$( "/usr/lib/qt6/bin/qmake" -query QT_INSTALL_LIBS )
...
codesign_file () {
	...
	codesign \
		...
		--force \
		--options runtime \
		--entitlements "/home/dibakard/Public_wireshark/wireshark/packaging/macosx/entitlements.plist" \
		--timestamp \
		--verbose \
		"$1" || exit 1
}
