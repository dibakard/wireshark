...
void wslua_register_classes(lua_State* L) {
	...
	wslua_reg_module(L, "Conversation", Conversation_register);
	...
	wslua_reg_module(L, "GcryptCipher", GcryptCipher_register);
...
void wslua_register_functions(lua_State* L) {
	...
	WSLUA_REGISTER_FUNCTION(register_packet_menu);
	...
	WSLUA_REGISTER_FUNCTION(get_color_filter_slot);
	...
	WSLUA_REGISTER_FUNCTION(redissect_packets);
	...
	WSLUA_REGISTER_FUNCTION(get_preference);
	WSLUA_REGISTER_FUNCTION(set_preference);
	WSLUA_REGISTER_FUNCTION(reset_preference);
	WSLUA_REGISTER_FUNCTION(apply_preferences);
	...
	WSLUA_REGISTER_FUNCTION(wtap_file_type_subtype_description);
	WSLUA_REGISTER_FUNCTION(wtap_file_type_subtype_name);
	WSLUA_REGISTER_FUNCTION(wtap_name_to_file_type_subtype);
	WSLUA_REGISTER_FUNCTION(wtap_pcap_file_type_subtype);
	WSLUA_REGISTER_FUNCTION(wtap_pcap_nsec_file_type_subtype);
	WSLUA_REGISTER_FUNCTION(wtap_pcapng_file_type_subtype);
	WSLUA_REGISTER_FUNCTION(gcry_cipher_algo_info);
	WSLUA_REGISTER_FUNCTION(gcry_cipher_algo_name);
	WSLUA_REGISTER_FUNCTION(gcry_cipher_map_name);
	WSLUA_REGISTER_FUNCTION(gcry_cipher_mode_from_oid);
	WSLUA_REGISTER_FUNCTION(gcry_cipher_get_algo_keylen);
	WSLUA_REGISTER_FUNCTION(gcry_cipher_get_algo_blklen);
}
